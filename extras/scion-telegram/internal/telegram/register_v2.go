...
func NewRegistrationHandler(store Store, api *TelegramAPIClient, hubURL, hmacKey, brokerID string, httpClient *http.Client, log *slog.Logger) *RegistrationHandler {
	if log == nil {
		log = slog.Default()
	}
	if httpClient == nil {
